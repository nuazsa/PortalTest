    ...
    <div className="flex-1 overflow-auto bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="max-w-6xl mx-auto p-4 md:p-8">
        ...
        <div className="text-center mb-12 md:mb-16 relative">
          ...
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-4 md:mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <div className="px-5 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full text-sm font-medium shadow-lg">
              ✨ Gratis & Akurat
            </div>
            <div className="px-5 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full text-sm font-medium shadow-lg">
              🎯 Hasil Instan
            </div>
            <div className="px-5 py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full text-sm font-medium shadow-lg">
              🔬 Berbasis Sains
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 md:p-8 border border-white/20 hover:scale-105 transition-all duration-300">
              <div className="flex items-center mb-4">
                <div className="p-3 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 shadow-lg mr-4">
                  <FiUser className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">RIASEC Test</h2>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <Link
                  href="/riasec"
                  className="w-full sm:w-auto text-center px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-200 shadow-lg hover:shadow-xl font-semibold inline-flex items-center justify-center"
                >
                  Mulai Tes
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 md:p-8 border border-white/20 hover:scale-105 transition-all duration-300">
              <div className="flex items-center mb-4">
                <div className="p-3 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 shadow-lg mr-4">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <Link
                  href="/mbti"
                  className="w-full sm:w-auto text-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-200 shadow-lg hover:shadow-xl font-semibold inline-flex items-center justify-center"
                >
                  Mulai Tes
                  <FiArrowRight className="ml-2 w-5 h-5" />
                </Link>
        ...
        <div className="relative">
          ...
          <div className="bg-white/60 backdrop-blur-xl rounded-3xl p-6 md:p-12 text-center shadow-2xl border border-white/20">
            <div className="flex justify-center mb-6">
              <div className="p-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 shadow-lg">
                <FiStar className="w-8 h-8 md:w-12 md:h-12 text-white" />
              </div>
            </div>
            <h3 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent mb-4">
